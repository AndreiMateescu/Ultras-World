...
namespace BackUp1Final.Controllers
{
    public class RolesController : Controller
    {
        ...
        public ActionResult RoleAddToUser(string UserName, string RoleName)
        {
            ...
            {
                ViewBag.Message = "Error! This user has another role !";
            ...
            rolelist = context.Roles.OrderBy(r => r.Name).ToList().Select(rr => new SelectListItem { Value = rr.Name.ToString(), Text = rr.Name }).ToList();
            ViewBag.Roles = rolelist;
            userlist = context.Users.OrderBy(u => u.UserName).ToList().Select(uu =>
            new SelectListItem { Value = uu.UserName.ToString(), Text = uu.UserName }).ToList();
            ViewBag.Users = userlist;
